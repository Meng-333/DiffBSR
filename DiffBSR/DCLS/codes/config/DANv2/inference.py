...
input_dir = '/root/autodl-tmp/DCLS/infer/img'
output_dir = '/root/autodl-tmp/DCLS/infer/results'
...
test_files = glob(osp.join(input_dir, "*tif"))
for inx, path in tqdm(enumerate(test_files)):
    ...
    save_path = osp.join(output_dir, "{}_x{}_DANv2.tif".format(name, opt["scale"]))
