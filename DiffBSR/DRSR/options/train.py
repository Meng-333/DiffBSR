...
parser.add_argument('--dir_data', type=str, default='/root/autodl-tmp/DiffBSR/load/UCM_train/',
                    help='dataset directory')
parser.add_argument('--data_val_while_training', type=str, default='/root/autodl-tmp/DiffBSR/load/UCM_val/',
                    help='test dataset name')
#parser.add_argument('--dir_data', type=str, default='/root/autodl-tmp/DiffBSR/load/train/',
                    #help='dataset directory')
#parser.add_argument('--data_val_while_training', type=str, default='/root/autodl-tmp/DiffBSR/load/val/',
                    #help='test dataset name')
parser.add_argument('--batch_size', type=int, default=16, help='input batch size for training')
parser.add_argument('--scale', type=str, default='4', help='super resolution scale')
parser.add_argument('--patch_size', type=int, default=256, help='intput patch size')
...
parser.add_argument('--save_model_dir', type=str, default='/root/autodl-tmp/DRSR/runs/checkpoint/', help='save output results')
...
parser.add_argument('--sig', type=float, default=2, help='specific sigma of isotropic Gaussian blurs')  # 测试的时候定义
