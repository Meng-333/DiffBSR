...
def fast_samples_fn(
    model, diffusion, ctx, k_v, shape, device, skip=10, eta=0.0, include_x0_pred_freq=10
):
...
class DiffBlindSR3AtomModel(pl.LightningModule):
    ...
    def validation_epoch_end(self, outputs):
        ...
        # f = open('./logs/blindsrsnf_iso/validation_epoch_end.txt', 'a')
        #f = open('./logs/blindsrsnf_aniso/validation_epoch_end.txt', 'a')
        f = open('./logs/blindsrsnf_aniso_UCM/validation_epoch_end.txt', 'a')
